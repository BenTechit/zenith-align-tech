export const t = {
  ...
  // ─────────────── HEBREW ───────────────
  he: {
    nav: { services: "שירותים", whyBentech: "למה Bentech", contact: "צרו קשר", phone: "052-637-9747" },
    ...
    who: {
      ...
      intro: "אם אתם מנהלים צוות של 5–50 אנשים במודיעין או בסביבה — והטכנולוגיה שלכם מוחזקת בפלסטר — זה בדיוק בשבילכם.",
      bullets: [
    ...
    services: {
      h2: "מה אני מטפל בו, כדי שלא תצטרכו",
    ...
    risk: {
      ...
      cards: [
        ...
        { title: "חומרה ישנה, עומס עבודה מודרני", desc: "צוות שעובד על חומרה לא מספיקה או מיושנת מאבד שעות כל שבוע. זו לא בעיית חומרה — זו בעיית הכנסה הנמדדת בפרודוקטיביות שאתם לא מקבלים." },
    ...
    cta: {
      h2: "מוכנים להפסיק לדאוג ל-IT?",
      sub: "בואו נתחיל עם הערכה חינמית. אני אבדוק מה יש לכם, אספר לכם מה עובד, מה לא, ומה צריך לשנות. ללא מגרש מכירות. ללא התחייבות.",
      steps: [
        { title: "אתם יוצרים איתי קשר", desc: "התקשרו, WhatsApp, או מלאו את הטופס" },
        { title: "אנחנו מדברים 15 דקות", desc: "ספרו לי על המערכות שלכם ועל נקודת הכאב הגדולה ביותר" },
        { title: "אני נותן לכם תשובה ישירה", desc: "מה דורש תשומת לב, מה יכול לחכות, ומה זה יעלה" },
      ],
      button: "קבלו הערכת IT חינם",
    ...
    contact: {
      ...
      error: "משהו השתבש. נסו שוב או התקשרו ישירות.",
      ...
      quote: "\"אני עובד עם בעלי עסקים ישירות, לא דרך שכבות של צוות תמיכה. כשפונים ל-Bentech, מדברים עם האדם שבאמת יתקן את זה.\"",
