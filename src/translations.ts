export const t = {
  en: {
    ...
    contact: {
      ...
      painPointPh: "Biggest pain point *",
      painPoints: [
        "Slow computers",
        "Backup & recovery",
        "Microsoft 365 setup",
      ...
      callbackNote: "I'll call you within 1 business day.",
      detailedFormToggle: "Tell me more about your setup",
      backToQuick: "Back to quick form",
  ...
  he: {
    ...
    hero: {
      ...
      trust: "ללא התחייבות. ללא ז'רגון טכני. רק שיחה ישירה על המערכות שלכם.",
    ...
    reviews: {
      ...
      items: [
        { name: "דוד ר.", role: "משרד עורכי דין, מודיעין", badge: "משרד עורכי דין", stars: 5, quote: "בן העביר את כל המשרד שלנו ל-Microsoft 365 ביום אחד. אפס השבתה, אפס בלבול. היינו צריכים לעשות את זה לפני שנים." },
        { name: "שירה מ.", role: "סוכנות שיווק", badge: "סוכנות שיווק", stars: 5, quote: "סוף סוף, אדם אחד שמטפל בהכל. לא עוד שלוש שיחות לשלושה אנשים שונים על שלוש בעיות שונות." },
        { name: "אורן כ.", role: "משרד רואי חשבון", badge: "משרד רואי חשבון", stars: 5, quote: "הגיבויים שלנו לא באמת עבדו. בן תפס את זה, תיקן, והגדיר ניטור כדי שזה לא יקרה שוב." },
        { name: "נועה ט.", role: "מנהלת מרפאה", badge: "מרפאה", stars: 5, quote: "מהיר, אמין, והוא באמת מסביר דברים בצורה שאני מבינה. ממליצה בחום." },
      ],
    },
    ...
    cta: {
      ...
      sub: "בואו נתחיל עם הערכה חינמית. אני אבדוק מה יש לכם, אספר לכם מה עובד, מה לא, ומה צריך לשנות. בלי שיחת מכירה. בלי התחייבות.",
      steps: [
    ...
    contact: {
      ...
      issuePh: "תארו את הבעיה *",
      devicePh: "סוג מכשיר *",
      serviceLabel: "שירות נדרש * (ניתן לבחור מספר)",
      send: "שלחו הודעה",
      sending: "שולח...",
      sent: "ההודעה נשלחה",
      sentSub: "תודה. אחזור אליכם בקרוב.",
      ...
      callbackNote: "אחזור אליכם תוך יום עסקים אחד.",
      detailedFormToggle: "ספרו לי עוד על המערכת שלכם",
      backToQuick: "חזרה לטופס מהיר",
